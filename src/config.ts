...
// Network
export const TRAINING_DATA: string = 'training.csv';
export const ACTIVATION_FUNCTION: Activation = Activation.sigmoid;
export const MUTATION_AMOUNT: number = 0.1;
export const NUM_NETWORKS: number = 250;
...
export const CAR_SPEED: number = 3;
